...
// The shared layout + generic pose library moved to tools/core/cells.mjs
// (Sprint 27 Phase 1) so the Character Creator and the CLI read ONE copy.
// Everything is re-exported here so existing importers are unchanged.
export {
  CELL_W, CELL_H, COLS, ROWS, CELLS, MOVES, LOW, LYING, V2_BUTTONS, buildJobs, gridFor,
} from './core/cells.mjs';
import { LOW } from './core/cells.mjs';
