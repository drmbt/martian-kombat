...
// only re-animates when the message actually changes. What to show comes
// from the shared pure bannerFor() in presentation/banner.
import type { BannerVariant } from '../presentation/banner';
export type { BannerVariant } from '../presentation/banner';
